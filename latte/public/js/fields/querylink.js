...
frappe.ui.form.ControlQueryLink = frappe.ui.form.ControlData.extend({
	make_input: function() {
		var me = this;
	...
	setup_awesomeplete: function() {
		...
		this.$input.on("input", frappe.utils.debounce(function(e) {
			...
			var args = {
				'txt': term,
				'doctype': me.df.options.split(".")[0],
				'ignore_user_permissions': me.df.ignore_user_permissions,
				'reference_doctype': me.get_reference_doctype(),
				'returnfield': me.df.options.split(".")[1]
			};
			...
			frappe.call({
				type: "POST",
				method:'latte.utils.search.search_link',
				no_spinner: true,
				args: args,
				callback: function(r) {
		...
		this.$input.on("awesomplete-select", function(e) {
			...
			me.parse_validate_and_set_in_model(item.returnfield);
		});
	...
	validate: function(value) {
		...
		this.df.ignore_link_validation = true;
